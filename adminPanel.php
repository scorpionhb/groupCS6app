...
<ul>
    ...
    <?php
        ...
        $UpdateQuery = $mysqli->query("UPDATE users JOIN type_of_user ON users.username = type_of_user.username SET access_level='$_POST[UserAccess]' email='$_POST[UserEmail]',tel_number='$_POST[UserPhone]',type_of_user='$_POST[UserType]' WHERE userID='$_POST[hidden]'");
